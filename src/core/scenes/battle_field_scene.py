...
from src.graphics.visual_board import VisualBoard
...
class BattleFieldScene(Scene):
    ...
    def update(self, dt: float) -> None:
        ...
        self.__visual_board.update(dt)

    def render(self):
        self.__visual_board.render()
