...
class Board:
    ...
    def place_card_on_blue_side(self, card: Card, position: int) -> None:
        if card.is_turret() is True:
            raise ValueError("Card is a turret, use place_turret_card_on_blue_side instead")
    ...
    def place_card_on_red_side(self, card: Card, position: int) -> None:
        if card.is_turret() is True:
            raise ValueError("Card is a turret, use place_turret_card_on_red_side instead")
